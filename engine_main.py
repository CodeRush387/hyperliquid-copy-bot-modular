...
from engine_startup import load_startup_state
...
async def main() -> None:
    ...
    if EXECUTION_ENABLED:
        ...
        log.warning(
            "[EXECUTION_DISABLED] observation only; no order client created"
        )
